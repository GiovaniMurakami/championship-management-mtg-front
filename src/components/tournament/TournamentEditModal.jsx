                ...
                <form onSubmit={handleSubmit} className="p-6 grid gap-5">
                    ...
                    <div className="flex flex-col gap-4 p-4 border border-[rgba(79,70,229,0.2)] rounded-[10px] bg-[rgba(79,70,229,0.04)]">
                        ...
                        <div className="flex flex-col gap-1.5">
                            ...
                            <input id="edit-nome" name="nome" type="text" value={form.nome} onChange={handleChange} required disabled={loading} className={TOURNAMENT_INPUT_CLASS} />
                        </div>
                        ...
                        <div className="flex flex-col gap-1.5">
                            ...
                            <input id="edit-horario" name="horario" type="datetime-local" value={form.horario} onChange={handleChange} required disabled={loading} className={TOURNAMENT_INPUT_CLASS} />
                        </div>
                        <div className="flex flex-col gap-1.5">
                            <label htmlFor="edit-formato" className="text-[#e0e0e0] font-medium text-[0.9rem]">Formato</label>
                            <div className="relative">
                                <select id="edit-formato" name="formato" value={form.formato} onChange={handleChange} disabled={loading} className={`${TOURNAMENT_INPUT_CLASS} w-full appearance-none pr-10`}>
                        ...
                        <div className="flex flex-col gap-1.5">
                            ...
                            <input id="edit-premio" name="premio" type="text" value={form.premio} onChange={handleChange} disabled={loading} className={TOURNAMENT_INPUT_CLASS} />
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-4 p-4 border border-[rgba(79,70,229,0.2)] rounded-[10px] bg-[rgba(79,70,229,0.04)]">
                        ...
                        <div className="grid grid-cols-2 gap-4 max-[480px]:grid-cols-1">
                            <div className="flex flex-col gap-1.5">
                                ...
                                <input id="edit-maxJogadores" name="maxJogadores" type="number" min="2" value={form.maxJogadores} onChange={handleChange} disabled={loading} className={TOURNAMENT_INPUT_CLASS} />
                            </div>
                            <div className="flex flex-col gap-1.5">
                                <label htmlFor="edit-maxRodadas" className="text-[#e0e0e0] font-medium text-[0.9rem]">Limite de Rodadas</label>
                                <input id="edit-maxRodadas" name="maxRodadas" type="number" min="1" value={form.maxRodadas} onChange={handleChange} disabled={loading} aria-describedby="edit-maxRodadas-help" className={TOURNAMENT_INPUT_CLASS} />
                        ...
                        <div className="flex flex-col gap-1.5">
                            ...
                            <div className="relative">
                                <select id="edit-corteTop" name="corteTop" value={form.corteTop} onChange={handleChange} disabled={loading} className={`${TOURNAMENT_INPUT_CLASS} w-full appearance-none pr-10`}>
                    ...
                    <div className="flex flex-col gap-4 p-4 border border-[rgba(79,70,229,0.2)] rounded-[10px] bg-[rgba(79,70,229,0.04)]">
                        ...
                        <div className="flex flex-col gap-1.5">
                            ...
                            <input id="edit-linkBanner" name="linkBanner" type="url" placeholder="https://..." value={form.linkBanner} onChange={handleChange} disabled={isDisabled} className={TOURNAMENT_INPUT_CLASS} />
                        ...
                        <div className="flex flex-col gap-1.5">
                            ...
                            <input id="edit-somRodada" name="somRodada" type="url" placeholder="https://.../som.mp3" value={form.somRodada} onChange={handleChange} disabled={isDisabled} className={TOURNAMENT_INPUT_CLASS} />
                        </div>
                        <div className="flex flex-col gap-1.5">
                            ...
                            <input id="edit-linkLive" name="linkLive" type="url" placeholder="https://youtube.com/..." value={form.linkLive} onChange={handleChange} disabled={isDisabled} className={TOURNAMENT_INPUT_CLASS} />
                        </div>
                    </div>
