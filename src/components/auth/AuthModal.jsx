  ...
  return (
    ...
    >
      ...
      >
        ...
        {message && (
          <p className="mt-[0.7rem] mb-0 px-3 py-3 rounded-[0.6rem] bg-[rgba(167,79,255,0.15)] text-[#d7b8ff] text-[0.9rem] animate-[slide-up_300ms_ease-out,fade-in_300ms_ease-out]">
            {message}
          </p>
        )}
      </section>
