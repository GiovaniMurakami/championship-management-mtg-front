    ...
    <div className={joinClassNames("relative", wrapperClassName)}>
      ...
      <span
        className={joinClassNames(
          "pointer-events-none absolute right-[0.9rem] top-1/2 h-2 w-2 -translate-y-[62%] rotate-45 border-b-2 border-r-2 border-[rgba(245,237,255,0.72)]",
