    ...
    >
      <div className="pointer-events-auto mx-auto w-[min(720px,calc(100vw-1.5rem))] rounded-2xl border border-[rgba(217,180,255,0.28)] bg-[rgba(14,9,28,0.96)] backdrop-blur-xl p-4 sm:p-5 shadow-[0_16px_40px_rgba(3,2,8,0.55)]">
        <p
          ...
          className="m-0 mb-2 text-[0.72rem] font-bold uppercase tracking-[0.12em] text-brand"
        >
        ...
        <p id="cookie-consent-text" className="m-0 text-[0.88rem] leading-relaxed text-[#e8dfff]">
          ...
          <Link to="/privacidade" className="text-brand font-semibold underline underline-offset-2 hover:text-white">
            Política de Privacidade
          </Link>
          {" · "}
          <Link to="/termos-de-uso" className="text-brand font-semibold underline underline-offset-2 hover:text-white">
            Termos de Uso
          </Link>
        </p>
        ...
        <button
          type="button"
          className="mt-3 text-[0.78rem] font-semibold text-text-soft underline underline-offset-2 bg-transparent border-0 p-0 cursor-pointer hover:text-white"
        ...
        {detailsOpen && (
          <ul className="mt-3 mb-0 pl-4 text-[0.82rem] leading-relaxed text-[#d8cff0] grid gap-2">
            <li>
              <strong className="text-text-main">Necessários</strong> — sessão, autenticação, preferências
              e segurança. Sempre ativos, pois o site não funciona sem eles.
            </li>
            <li>
              <strong className="text-text-main">Anúncios</strong> — Google AdSense. Com “Aceitar todos”,
