...
> Versão do app: **1.2.28** | Idioma da UI e APIs: **português (BR)**
...
*Última revisão: agosto/2026 — alinhado com v1.2.28 (soft-delete UI, auto-drop, standings full-width, acentuação de badges)*
